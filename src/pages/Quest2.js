...
const Quest2 = () => {
    ...
    const url = "https://screening.moduit.id/frontend/web/question/two";
                ...
                <div className="col roww">
                    ...
                    <nav className="navbar navbar-light navnav">
                        <div className="container-fluid">
                            <a className="navbar-brand">Question 2</a>
                            <form className="d-flex">
                            <input className="form-control search me-2" type="search" placeholder="Search by product name" aria-label="Search" />
